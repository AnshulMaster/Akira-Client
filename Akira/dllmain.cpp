...
#include "Akira/hook/HookManager.h"
#include "Akira/module/ModuleManager.h"
#include "Akira/data/GameData.h"
#include "Akira/utils/Utils.h"
...
void Init(LPVOID lpParam) {
    ...
    Utils::DeletePath("Akira/logs.txt");
